...
sidebar_label: 4. Export Datasource
---
...
- [Live Sync](#live-syncing-simulations-with-the-export-file-that-fetches-real-time-data) simulations with the export file that fetches real-time data
 <div class="center">
  <Zoom>
   <img alt="Export as Datasource" src={useBaseUrl('/doc-images/export-customization.png')} />
  </Zoom>
 </div>
...
:::note
This feature is only available in Professional and Enterprise plans.
:::
...
2. You can either **Select** *Series/Scenarios* to export, or **Export all** of them.
 ...
 <div style={{ textAlign: "center" }}>
  <Zoom>
   <img alt="Export all the Series/Scenarios" src={useBaseUrl('/doc-images/web-datasource/export-all.png')} />
  </Zoom>
...
4. The data can be exported in either a *Tree structure* or a *Flat structure* as shown in the **Export format** screen:
 ...
 <div style={{ textAlign:"center" }}>
  ...
  <div class="center"><p>Export format with Flat structure</p></div>
 </div>

   - **Customization**: The tab in the *Flat* structure has an additional field - **Parent title**.
   :::note
...
<div class="center">
  ...
  <p>Live synch simulations in Power BI Desktop</p>
</div>

For the dataset refresh in Power BI Service, validate your credentials as explained below:

* Select the 3 vertical dots next to your dataset and then select **Settings**.

<div style={{textAlign: "center"}}>
  <Zoom>
    <img
      alt="Dataset settings"
      width="550"
      src={useBaseUrl("/doc-images/settings.png")}
    />
  </Zoom>
  <p>Dataset settings</p>
</div>

* From the **Datasets** tab, select **Data source credentials > Edit credentials**.

<div class="center">
  <Zoom>
    <img
      alt="Edit credentials"
      src={useBaseUrl("/doc-images/edit-credentials.png")}
    />
  </Zoom>
  <p>Edit credentials for dataset refresh</p>
</div>

* Enable **Skip test connection**, and then select **Sign in**.

<div class="center">
  <Zoom>
    <img
      alt="Configure credentials"
      src={useBaseUrl("/doc-images/configure.png")}
    />
  </Zoom>
  <p>Configure and validate credentials</p>
</div>

Now, click on the **Refresh** ( <img width="20" src={useBaseUrl("/img/refresh.png")}/> ) icon next to the dataset to sync up your visual with the latest data.
