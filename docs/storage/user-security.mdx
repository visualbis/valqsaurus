...
This feature is only available in Enterprise plans.
  <div class="center">
    <Zoom>
      <img alt="User security feature not available" src={useBaseUrl('/doc-images/storage/security-denied.png')} />
    </Zoom>
    <p>Upgrade plan to Enterprise to enable the User security feature</p>
  </div>  
:::
