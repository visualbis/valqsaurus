...
“Import from Excel” option in “Import an Advanced Model” tab (Refer <Link to={useBaseUrl('/docs/model/new#import-from-an-export-file')}> `Section: Import from an Export File <IEF>`  </Link>).
