...
_Writeback settings - exporting simulation affected nodes only_
...
_Writeback feature accessible from the Navigation Panel_
...
_Selected series/scenarios to post_
...
_Writeback posted successfully_
