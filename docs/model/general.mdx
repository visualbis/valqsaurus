...
You can right-click to download the schema file here <a href={useBaseUrl('/assets/jsonSchema.json')} download>ValQ Writeback Schema.json</a>
### Writeback History

History of the Writeback logs are maintained and is accessed by clicking on the history icon right above the Writeback button in the Navigation panel.
