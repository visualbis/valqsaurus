...
<div style={{ textAlign: "justify" }}>
  ...
  <img
    ...
    height={32}
  />{" "}
  on ValQ to access the Node options.
</div>
...
<div style={{ textAlign: "justify" }}>
  In the Configuration settings, you will be able to configure the node details
...
<div style={{ textAlign: "justify" }}>
  On selecting Formula as Calculation Method and clicking on the formula field,
  you will be able to see a dropdown of the formulas that are supported. For a
  list of formulas that are available in ValQ, you can refer to the link{" "}
  <Link to={useBaseUrl("/docs/faq/formula-list")}>Functions</Link>.
</div>
...
<div style={{ textAlign: "justify" }}>
  A Template Node can be created with the help of an existing node. Add a new
  node and select its Calculation Method as Template based on other nodes. Now
  select the node you want to copy under node to use as a template. In the below
  example, North branch has been created using East as template.
</div> <br />
...
<div style={{ textAlign: "justify" }}>
  ...
  of the Node. For instance, income has an increasing trend and expense has
  decreasing trend.
</div> <br />
...
<div style={{ textAlign: "justify" }}>
  Dynamic Children is available to create a new node that is replicate of
...
<div style={{ textAlign: "justify" }}>
  ...
  such as{" "}
  <Link to={useBaseUrl("docs/model/node#node-display")}>Node display</Link> and{" "}
  <Link to={useBaseUrl("docs/model/node#details-on-click")}>
    Details on Click
  </Link>
  . The other setting options available under Display are:
</div> <br />
...
<div style={{ textAlign: "justify" }}>
  Value Prefix and Value Suffix options are used to add prefix and suffix like
  currency, units of your choice to the node value. In the below example, $ is
  added as Value Prefix and n is added as Value Suffix to 'East' node.
</div> <br />
...
<div style={{ textAlign: "center" }}>
  <Zoom>
    <img
      ...
      src={useBaseUrl("/doc-images/model/node35.png")}
    />
  </Zoom>
</div>
...
<div style={{ textAlign: "justify" }}>
  In the Simulation Settings, you will be able to configure simulation details
  such as the selection of the Default Simulation Method and assigning the node
...
<div style={{ textAlign: "justify" }}>
  ...
  get the tooltip showing the period values and the simulation Default Method.
  You can also change the Default Method here.
</div> <br />
...
<div style={{ textAlign: "center" }}>
  <Zoom>
    <img
      ...
      src={useBaseUrl("/doc-images/model/node41.png")}
    />
  </Zoom>
</div>
...
<div style={{ textAlign: "justify" }}>
  ...
  <Link to={useBaseUrl("docs/model/settings#5-conditional-formatting")}>
    settings
  </Link>
  . This is done by applying alert thresholds and rules for the model at node
  level.
</div> <br />
...
<div style={{ textAlign: "justify" }}>
  In the Grid View, you will be able to edit the nodes and save it so that the
...
<div style={{ textAlign: "justify" }}>
  ...
  user can select the appropriate node from the same. In the below Figure, node
  search for Linked Simulation Node has been made.
</div> <br />
...
<div style={{ textAlign: "justify" }}>
  The columns can be filtered based on the selection from Selected Columns drop
  down (see Figure below). All Columns option can be selected to get all the
  features displayed in the grid or you can select only the columns that you
  want.
</div> <br />
...
<div style={{ textAlign: "justify" }}>
  ...
  using the Import from Excel and Export to Excel buttons as shown in the below
  Figure.
</div> <br />
