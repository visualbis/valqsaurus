...
<div style={{ textAlign: "justify" }}>
  ...
  example,the North branch has been created using East as template.
</div> <br />
...
_Template based on other nodes_
...
_Select the increase/decrease Desired Trend_
...
_Before applying formula based Secondary KPIs_
...
_Before applying template based Secondary KPI_
...
_Configuration for formula based Secondary KPI_
...
_Formula based Secondary KPI to be used as template_
...
_Calculation Method on Quick Editor_
...
_Linked Sim Node on Quick Editor_
...
_Business View on Quick Editor_

</div>


<div style={{ textAlign: "justify" }}>
  The columns can be filtered based on the selection from the Selected Columns
  drop-down (see Figure below). All Columns option can be selected to get all
  the features displayed in the grid or you can select only the columns that you
  want.
</div> <br />
...
_Simulation lock on Quick Editor_
...
_Parent change for node ‘Ryan Smith’_
...
| Configuration          | Calculation Method                | This property sets the Calculation Method for the Node. The options are <br/> Data Source <br/> Sum Children (a+b+c….) <br/> Subtract Children (a-b-c….) <br/> Multiply Children (a*b*c….)<br/> Divide Children (a/b/c….) <br/> Formula<br/> Linked to Node<br/> Manual <br/> Templated based on other node. <br/> Note: When the Calculation Method is selected as _Linked to Node_ option, then you can select the desired node from the Nodes List. |  |
