...
Also you can expand, collapse and delete the nodes
using the options “Expand”, “Collapse” and “Delete”.
</ div> <br />
...
<div style={{textAlign: 'center'}}>
  <Zoom>
<img alt="New Tab" src={useBaseUrl('/doc-images/model/new7.png')} />
  </Zoom>
</ div> <br />

For our example, the Node name is given as “Conversion” and based
on the search you will be able to view the Node as highlighted.

<div style={{textAlign: 'center'}}>
  <Zoom>
<img alt="Display of the Searched Node" src={useBaseUrl('/doc-images/model/new8.png')} />
  </Zoom>
</ div> <br /> 

In the below Figure, you can observe that by clicking the “+” button, a
Node “Copy of Net Profit” has been added.
...
<div style={{textAlign: 'justify'}}>  
Similarly you can edit the Parent Node details by clicking the Edit button as shown below.
</ div> <br /   >

<div style={{textAlign: 'center'}}>
  <Zoom>
<img alt="Display of the Searched Node" src={useBaseUrl('/doc-images/model/new9.png')} />
  </Zoom>
</ div> <br /> 
