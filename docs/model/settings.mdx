...
<img alt="Enable /Disable Navigation Panel" src={useBaseUrl('/doc-images/edn.png')} />
...
<img alt="Scenarios" src={useBaseUrl('/doc-images/nav1.png')} />
...
<img alt="xml download of the Scenario 2 data" src={useBaseUrl('/doc-images/16.4.png')} />
...
<img alt="Scenarios" src={useBaseUrl('/doc-images/nav2.png')} />
...
<img alt="Simulation Period" src={useBaseUrl('/doc-images/nav3.png')} />
...
<img alt="Value Display" src={useBaseUrl('/doc-images/nav4.png')} />
...
<img alt="Key Inputs" src={useBaseUrl('/doc-images/nav5.png')} />
...
<img alt="KPIs" src={useBaseUrl('/doc-images/nav6.png')} />
...
<img alt="Constraints" src={useBaseUrl('/doc-images/nav7.png')} />

Based on the above settings, you will be able to view the valQ screen
with "Exit Design Mode" button (see Figure below).

<img alt="Exit Design Mode" src={useBaseUrl('/doc-images/nav8.png')} />
...
<img alt="valQ screen with Navigation Panel" src={useBaseUrl('/doc-images/nav9.png')} />
...
<img alt="Data Mapping Format" src={useBaseUrl('/doc-images/nm1.png')} />
...
<img alt="Default Node Style" src={useBaseUrl('/doc-images/nm3.png')} />
...
<img alt="Node Settings" src={useBaseUrl('/doc-images/nm4.png')} />
...
<img alt="valQ screen with Node Settings" src={useBaseUrl('/doc-images/nm5.png')} />
...
<img alt="Pop up screen showing Horizontal Chart Type" src={useBaseUrl('/doc-images/nm6.png')} />
...
<img alt="Node Style and Node Element Selection" src={useBaseUrl('/doc-images/va3.png')} />
...
<img alt="Node showing Contribution Percentage values in Ascending
order" src={useBaseUrl('/doc-images/va4.png')} />
...
<img alt="Node showing Performance Variance Percentage values in Ascending
order" src={useBaseUrl('/doc-images/va5.png')} />
...
<img alt="Canvas with Default Visual settings" src={useBaseUrl('/doc-images/cv1.png')} />

Based on the above settings, you will be able to view the valQ screen
with the Table appearance (see Figure below).

<img alt="Canvas with default Table Visual" src={useBaseUrl('/doc-images/cv2.png')} />

2.  For our example, set the property "Start the model with the
    following KPI" to the option "9:Total Cost" (see Figure below).

<img alt="Canvas Settings" src={useBaseUrl('/doc-images/cv3.png')} />
...
<img alt="valQ screen with Canvas Settings" src={useBaseUrl('/doc-images/cv4.png')} />
...
<img alt="Number Formatting Settings" src={useBaseUrl('/doc-images/nf1.png')} />
...
<img alt="valQ screen with Number Formatting Settings" src={useBaseUrl('/doc-images/nf2.png')} />
...
<img alt="Conditional Formatting Settings" src={useBaseUrl('/doc-images/cf1.png')} />
...
<img alt="Conditional Formatting - Format based on Variance
Percentage" src={useBaseUrl('/doc-images/cf2.png')} />
...
<img alt="Conditional Formatting Settings" src={useBaseUrl('/doc-images/cf3.png')} />

5.  Based on the above settings, you will be able to view the Tree as
    shown below.

<img alt="Conditional Formatting - Format based on Simulation
Percentage" src={useBaseUrl('/doc-images/cf4.png')} />
...
<img alt="Color Theme Settings" src={useBaseUrl('/doc-images/clr1.png')} />
...
<img alt="valQ screen with Color Theme Settings" src={useBaseUrl('/doc-images/clr2.png')} />

Also you can observe that the Navigation Panel will be shown in Dark
Theme based on the configuration.

<img alt="Navigation Panel with Dark Theme" src={useBaseUrl('/doc-images/clr3.png')} />

For our example, you have configured the Highlighted color for the Node
as Red Color (see Figure below).

<img alt="Highlighted Color Settings for Node" src={useBaseUrl('/doc-images/hc1.png')} />
...
<img alt="Node Highlighted color appearing in Red color" src={useBaseUrl('/doc-images/hc2.png')} />
...
|                        | Waterfall   Chart Type                                            | The Pop   up screen will be appearing with the type of the Waterfall Chart being   selected. The options are Vertical and Horizontal.                                                                                                                                                                                                                                                                        |
