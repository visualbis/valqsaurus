...
![Left Panel and Right Canvas](assets/catg.png)

The Model tab has five different Tab options (see Figure below).

![Tab option for the Model tab](assets/tabs.png)
...
![Power BI with Visualizations and Fields Panel](assets/11.1.png)
...
![valQ Screen - Measures to be assigned](assets/eleven.png)
...
![Assigning the Measure Value](assets/11.3.png)
...
![Loading screen](assets/12.2a.png)

For our example, the sample “Mining Industry” has been selected.

![Selection of sample model](assets/12.2.png)
...
![valQ screen with Nodes settings](assets/12.3.png)
...
![Node Search option in right canvas](assets/12.4.png)
...
![Display of the Searched Node](assets/12.5.png)

![Nodes Structure with Add option](assets/12.6.png)
...
![Nodes Structure with Edit option](assets/12.7.png)
...
![Edit Node – General Settings](assets/12.8.png)

Based on the above configuration, you will be able to view the valQ
screen as shown below.

![valQ screen with General settings](assets/12.9.png)
...
![Node with Prefix value as Spouse 1](assets/12.10.png)

![Node with Prefix value as Spouse 2](assets/12.11.png)

Based on the above set of configurations, you will be able to view the
valQ screens as shown below.

![valQ screen with Spouse 1 Prefix](assets/12.12.png)

![valQ screen with Spouse 2 Prefix](assets/12.13.png)
...
and Revenue Node to be used as Template](assets/13.4.png)
...
![Templated Node](assets/13.5.png)
...
![Pop up screen](assets/12.18.png)
...
![Tree with several nodes](assets/cnd1.png)
...
![Adding Composite Nodes](assets/cnd2.png)
...
![Tree with composite nodes](assets/cnd3.png)
...
![Composite Node with simulated values](assets/cnd4.png)
...
![Quick Editor with composite node id display](assets/cnd5.png)
...
![valQ with Simulation Settings](assets/12.19.png)
...
![valQ screen with Constant value selection](assets/12.20.png)
...
![Conditional Formatting Settings for Node](assets/cfn1.png)
...
Percentage selection](assets/cfn2.png)
...
Node "Copper Price"](assets/cfn4.png)
...
![](assets/SecKPIF.2.png)

![](assets/SecKPIF.3.png)
...
next level hierarchy](assets/dsm.png)
...
![Read Only Dynamic Tree](assets/12.28.png)
...
![Dynamic Scaling on Dynamic Tree](assets/12.29.png)
...
![Dynamic Model converted to an Advanced Model](assets/conv2.png)
...
![Create New from Scratch](assets/12.38.png)

For our example we have created a Parent Node and two child Nodes (see
Figure below).

![Tree with one Parent Node and two Child Nodes](assets/12.39.png)
...
![valQ – Import from Excel](assets/12.30.png)
...
![Navigation Panel for the first tree configuration](assets/12.33.png)
...
![Import a Tree](assets/12.34.png)
...
![Navigation Panel for the second tree configuration](assets/12.35.png)
...
![Configuration Data from Export File Data Format](assets/12.36.png)

Now based on the above configuration, you will be able to view the Tree
formed with Nodes in the valQ screen.

![valQ screen derived from Export File Data Format](assets/12.37.png)
