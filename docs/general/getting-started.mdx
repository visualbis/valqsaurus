...
<div style={{fontStyle: "italic", textAlign: "center"}}> ValQ Screen </div> // image description
...
<img alt="Hiding Navigation Panel in Runtime" src={useBaseUrl('/doc-images/navp.png')} />
...
<img alt="..image::\/doc-images/image4" src={useBaseUrl('/doc-images/media/image4.png')} /> icon that you can click
...
<img alt="Value Display and Simulation Period" src={useBaseUrl('/doc-images/4.8.png')} />

**Full Year** – Shows the full year cumulated data

<img alt="Value Display and Simulation Period" src={useBaseUrl('/doc-images/4.9.png')} />
...
<img alt="Value Display and Simulation Period" src={useBaseUrl('/doc-images/4.10.png')} />
...
<img alt="Tooltip for Month Value Display" src={useBaseUrl('/doc-images/vd1.png')} />
...
<img alt="Data Simulation" src={useBaseUrl('/doc-images/4.13.png')} />
  ...
  - Click on the arrow icon of the node
    <img alt="..image::\/doc-images/image22" src={useBaseUrl('/doc-images/media/image20.png')} /> then click ‘Edit Key
...
<img alt='Simulated Node having "0" as values' src={useBaseUrl('/doc-images/zero1.png')} />
...
<img alt="..image::\/doc-images/image32" src={useBaseUrl('/doc-images/media/image30.png')} />
...
<img alt="Simulations - More option button" src={useBaseUrl('/doc-images/more.png')} />
...
<img alt="Context Drop Down Menu Items" src={useBaseUrl('/doc-images/sf3.png')} />
...
<img alt="Create a new Scenario and make it the active scenario
icon" src={useBaseUrl('/doc-images/sfi1.png')} />
...
<img alt="Full Year Scenario Comparison" src={useBaseUrl('/doc-images/sf7.png')} />

<img alt="Full Year Scenario Comparison" src={useBaseUrl('/doc-images/sf8.png')} />
...
<img alt="Download option in Scenario Comparison screen" src={useBaseUrl('/doc-images/scom1.png')} />
...
<img alt="Comparison Report with reordered Scenarios" src={useBaseUrl('/doc-images/sf10.png')} />
...
<img alt="Visualization - Display as Tree and View Mode selected as
Full" src={useBaseUrl('/doc-images/4.25.png')} />
...
<img alt="Visualization - Display as Table and View Mode selected as
Standard" src={useBaseUrl('/doc-images/4.26.png')} />
...
<img alt="Icon for Contextual Help Information" src={useBaseUrl('/doc-images/con1.png')} />
