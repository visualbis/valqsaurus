...
<div class="center">
  <Zoom>
    <img
      ...
      src={useBaseUrl("/doc-images/simulate_tab/edit-node-treetable.png")}
    />
  </Zoom>
  <p>Edit node icon accessible in both tree and table view</p>
</div>

* Added Back to main model for an easy navigation to switch to the main model in tree view.
...
* To do: Redesigned table view for better user experience
:::important
We need to have a few more points on this
:::
* To do: New UI for time period display has been applied to period selection dropdown in Variance Analysis.
