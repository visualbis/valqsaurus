...
<div>
  ...
  <div class="center"><p>Edit node icon accessible in both tree and table view</p></div>
</div>

* Added Back to main model for easy navigation and to switch back to the main model anytime in Tree view.
...
* Selecting a node in the plan series shows lineage up to last 3 levels in the footer.
