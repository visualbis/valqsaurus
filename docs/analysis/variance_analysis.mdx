...
<div style={{ textAlign: "center" }}>
  <Zoom>
    <img
      alt="ValQ logo"
      src={useBaseUrl("/doc-images/analyze/analyze1.2.png")}
    />
  </Zoom>
</div> <br />
...
A ValQ model with Comparison series is needed to perform Variance Analysis
...
<div style={{ textAlign: "justify" }}>
  On the top, you will find a panel containing the features that help to build
  the Variance analysis report as per your needs.
</div> <br />
...
<div style={{ textAlign: "center" }}>
  <Zoom>
    <img
      alt="ValQ logo"
      src={useBaseUrl("/doc-images/analyze/analyze2.1.png")}
    />
  </Zoom>
</div> <br />

<div style={{ textAlign: "justify" }}>
  The other panel shows the Variance Analysis report that you have built based
  on the model and it's configuration.
</div> <br />
...
<div style={{ textAlign: "center" }}>
  <Zoom>
    <img
      alt="ValQ logo"
      src={useBaseUrl("/doc-images/analyze/analyze2.2.png")}
    />
  </Zoom>
</div> <br />
...
<div style={{ textAlign: "justify" }}>
  Instead, a Scenario that you have created in the Simulate tab can also be set
  as Base Series.
</div> <br />
...
<div style={{ textAlign: "justify" }}>
  Select a period from the drop-down to get the same period values of both the
  series. In the below example, 'Apr' is selected from the drop-down. Variance
  Analysis is performed between April period values of 2020 Actuals and April
  period values of 2020 Forecast.
</div> <br />
...
<div style={{ textAlign: "justify" }}>
  To customize your selection, click on the Custom option from the drop-down and
  set different periods for Base Series and Compared Series.
</div> <br />
...
<div style={{ textAlign: "justify" }}>
  ...
  Full year, Quarter, Year-to-date, etc. ValQ performs Variance Analysis for
  each of the selected range.
</div> <br />
...
<div style={{ textAlign: "center" }}>
  <Zoom>
    <img
      alt="ValQ logo"
      src={useBaseUrl("/doc-images/analyze/analyze7.1.png")}
    />
  </Zoom>
</div>
...
<div style={{ textAlign: "center" }}>
  <Zoom>
    <img
      alt="ValQ logo"
      src={useBaseUrl("/doc-images/analyze/analyze8c.png")}
    />
  </Zoom>
</div>
...
<div style={{ textAlign: "justify" }}>
  ValQ adds the variances to all the nodes on the model for the selected time
  range. The positive variances are shown in green and the negative ones in red.
</div> <br />
...
The unit column is seen by default on Variance Anaylsis as below. To hide the column, un-check unit to disable the feature.
...
<div style={{ textAlign: "center" }}>
  <Zoom>
    <img
      alt="ValQ logo"
      src={useBaseUrl("/doc-images/analyze/analyze10.png")}
    />
  </Zoom>
</div>
...
<div style={{ textAlign: "justify" }}>
  Enable Show hidden nodes option to display the nodes that were hidden while
  building the model under the Model tab.
</div> <br />
...
<div style={{ textAlign: "justify" }}>
  The below image shows the Variance Analysis for top 5 variances for the full
