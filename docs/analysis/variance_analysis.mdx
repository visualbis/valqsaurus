...
*Variance Analysis option*

Here's the Variance Analysis screen on ValQ

<div style={{ textAlign: "center" }}>
  <Zoom>
    <img alt="" src={useBaseUrl("/doc-images/analyze/analyze1.png")} />
  </Zoom>
</div>
...
<div style={{ textAlign: "center" }}>
  <Zoom>
    <img alt="" src={useBaseUrl("/doc-images/analyze/analyze2.png")} />
  </Zoom>
</div>

*Selecting data series as the base series*
...
<div style={{ textAlign: "center" }}>
  <Zoom>
    <img alt="" src={useBaseUrl("/doc-images/analyze/analyze3.png")} />
  </Zoom>
</div>

*Selecting a scenario as the base series*
...
<div style={{ textAlign: "center" }}>
  <Zoom>
    <img alt="" src={useBaseUrl("/doc-images/analyze/analyze4.png")} />
  </Zoom>
</div>

*Select comparison series*
...
Select a period from the drop-down to get the same period values of both the series. In the below example, 'Apr' is selected from the drop-down. Variance Analysis is performed between April period values of 2020 Actuals and April period values of 2020 Forecast.

<div style={{ textAlign: "center" }}>
  <Zoom>
    <img alt="" src={useBaseUrl("/doc-images/analyze/analyze5.png")} />
  </Zoom>
</div>{" "}

*Time period selection for comparison series*
...
*Full-year time period analysis*
...
*Custom time period analysis report*
...
*Download the report as an excel sheet*
...
*Report filtered by top 5 variances*
...
*Reports filtered with only negative variances*
