...
ValQ's Variance Analysis helps compare the values of two or more data series for each of the nodes in the model and calculate variances - absolute and percentage for all the nodes.

:::note
Variance Analysis feature is fully unlocked in Professional and Enterprise plan.
...
1. [Features of Variance Analysis](#features-of-variance-analysis)
1. [1. Set Base Series](#1-set-base-series)
1. [2. Choose Compared Series](#2-choose-compared-series)
1. [3. Select Period for Data Series](#3-select-period-for-data-series)
    1. [3.1 Same Period for Base Series and Compared Series](#31-same-period-for-base-series-and-compared-series)
    1. [3.2 Custom Period for Base Series and Compared Series](#32-custom-period-for-base-series-and-compared-series)
1. [4. Choose Time Range for report](#4-choose-time-range-for-report)
    1. [4.1 Built-in Time Range](#41-built-in-time-range)
    1. [4.2 Add Custom Time Range](#42-add-custom-time-range)
1. [5. Show/hide Absolute variance and % variance](#5-showhide-absolute-variance-and--variance)
1. [6. Show/hide Unit column](#6-showhide-unit-column)
1. [7. Download the report as excel](#7-download-the-report-as-excel)
1. [8. Include hidden nodes to report](#8-include-hidden-nodes-to-report)
1. [9. Search for a node in the report](#9-search-for-a-node-in-the-report)
1. [10. Apply Filter to report](#10-apply-filter-to-report)
1. [11. Hide the features panel](#11-hide-the-features-panel)
...
<div style={{ textAlign: "center" }}>
  <Zoom>
    <img width="350" alt="" src={useBaseUrl("/doc-images/analyze/analyze7.png")} />
  </Zoom>
...
You can also add a Custom time range by selecting the custom option from the drop-down menu. The Custom time range can be selected along with other time ranges which is displayed at the end of the report.

<div class="center">
  <Zoom>
    <img alt="Custom Period" src={useBaseUrl("/doc-images/analyze/analyze8.png")} />
  </Zoom>
...
<div style={{ textAlign:"center" }}>
  <Zoom>
    <img width="100" alt="" src={useBaseUrl("/doc-images/analyze/filter.png")} />
  </Zoom>
</div>
