...
1.  For our example, expand East node. Now select the node
    'Industrials' and lock the node (see Figure below).
    <Zoom>
  <img alt="ValQ logo" src={useBaseUrl('/doc-images/plan/ba1.png')} />
  </Zoom>

2.  Now select the Total Cell for node 'East' as shown in the
    below Figure.

    <img alt="Cell selection" src={useBaseUrl('/doc-images/plan/ba2.png')} />
...
3.  Now double click the total cell and type '+10%' at the end of the
    ...
    <img alt="Total cell value increased to 10 %" src={useBaseUrl('/doc-images/plan/ba3.png')} />

4.  You will be able to view the 'Spread by Weights' screen.

    <img alt="Spread by Weights" src={useBaseUrl('/doc-images/plan/ba4.png')} />
...
5.  As an end result of the Scenario 1, you will be able to view the
    ...
    Revenue'" src={useBaseUrl('/doc-images/plan/ba5.png')} />
